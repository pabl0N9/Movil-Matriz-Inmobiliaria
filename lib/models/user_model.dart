...
class User {
  ...
  final DateTime? ultimoCambioPassword;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'ultimo_cambio_password': ultimoCambioPassword?.toIso8601String(),
      'roles': roles,
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    return User(
      ...
      ultimoCambioPassword: json['ultimo_cambio_password'] != null
          ? DateTime.tryParse(json['ultimo_cambio_password'].toString())
          : null,
  ...
  String get numeroDocumentoSeguro => numeroDocumento ?? '';
  String get tipoDocumentoSeguro => tipoDocumento ?? '';
}
