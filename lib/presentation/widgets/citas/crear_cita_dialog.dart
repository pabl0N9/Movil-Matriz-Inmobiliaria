...
class _CrearCitaDialogState extends State<CrearCitaDialog> {
  ...
  Future<void> _cargarHorariosDisponibles(DateTime fecha) async {
    ...
    try {
      ...
      final idServicio = _mapServicioToId(_servicioSeleccionado ?? 'Visita a Propiedad');
      final horarios = await service.obtenerHorariosDisponibles(fecha, idServicio: idServicio);
      setState(() {
...
class _DatePickerDialogState extends State<_DatePickerDialog> {
  ...
  Widget _buildCalendarGrid(DateTime month) {
    ...
    final isDisabled = date.isBefore(widget.firstDate) || date.isAfter(widget.lastDate) || isWeekend;
